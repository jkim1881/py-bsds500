...
pred_path = '/media/data_cifs/pytorch_projects/model_out_1' #'/media/data_cifs/pytorch_projects/MB_model_out_001' # '/media/data_cifs/pytorch_projects/model_out_001'
val_test = 'test'
suffix_ext = '.jpg'
thresholds = 100
